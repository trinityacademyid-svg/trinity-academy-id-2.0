...
export const DEFAULT_PRIVATE_PROGRAMS = [
  ...
  { title: 'Les Private SMA', jenjang: 'Kelas 10-12', desc: 'Penguatan materi dan persiapan ujian untuk semua jurusan. Tutor spesialis yang ahli di bidangnya masing-masing.', features: ['IPA, IPS & Bahasa', 'Persiapan ujian', 'Konsultasi jurusan', 'Tutor spesialis'] },
]

export const DEFAULT_ONLINE_PROGRAMS = [
...
export const DEFAULT_WHY_PRIVATE = [
...
export const DEFAULT_WHY_ONLINE = [
...
export const DEFAULT_SIGNATURE_PROGRAMS = [
  {
    id: 'tasa',
    number: '01',
    short: 'TASA',
...
export function getJsonSiteValue(content, key, fallback = []) {
  ...
  try {
    ...
    console.error(`Failed to parse site_content JSON for ${key}:`, error)
    return fallback
  }
}

export function buildWhatsAppUrl(number, message = '') {
  const fallbackNumber = SITE_FALLBACKS.wa_number
